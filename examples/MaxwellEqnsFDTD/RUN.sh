...
export SCAFESRUN_NAME_EXECUTABLE="$(basename $PWD)";
export SCAFESRUN_SPACE_DIM=3
export SCAFESRUN_N_NODES="8x8x8"
export SCAFESRUN_PARTITION_GRID="0x0x1"
...
#------------------------------------------------------------------------------#
export SCAFESRUN_RUN_MODE="DEBUG"
