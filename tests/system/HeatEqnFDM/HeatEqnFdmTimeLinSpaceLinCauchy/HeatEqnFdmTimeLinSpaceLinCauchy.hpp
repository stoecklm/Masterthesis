...
class HeatEqnFdmTimeLinSpaceLinCauchy : public HeatEqnFDM<CT,DIM, HeatEqnFdmTimeLinSpaceLinCauchy<CT,DIM> > {
  ...
  public:
     ...
     */
    HeatEqnFdmTimeLinSpaceLinCauchy(ScaFES::Parameters const& params,
        ...
        : HeatEqnFDM<CT, DIM, HeatEqnFdmTimeLinSpaceLinCauchy<CT,DIM> >(params, gg, useLeapfrog,
