...
#ifndef HEATEQNFDM_CAUCHY_TIMELINSPACECONST_HPP_
#define HEATEQNFDM_CAUCHY_TIMELINSPACECONST_HPP_

#include "ScaFES.hpp"
#include "Cauchy.hpp"

template<typename CT, std::size_t DIM>
class TimeLinSpaceConst : public Cauchy<CT,DIM, TimeLinSpaceConst<CT,DIM> > {
  ...
  public:
    ...
    TimeLinSpaceConst(ScaFES::Parameters const& params,
        ...
        : Cauchy<CT, DIM, TimeLinSpaceConst<CT,DIM> >(params, gg, useLeapfrog,
