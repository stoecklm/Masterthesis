...
#ifndef HEATEQNFDM_NEUMANN_HPP_
#define HEATEQNFDM_NEUMANN_HPP_

#include "ScaFES.hpp"
#include "HeatEqnFDM.hpp"

template<typename CT, std::size_t DIM, typename Class>
class Neumann : public HeatEqnFDM<CT,DIM, Neumann<CT,DIM, Class> > {
  ...
  public:
    ...
    Neumann(ScaFES::Parameters const& params,
        ...
        : HeatEqnFDM<CT, DIM, Neumann<CT,DIM,Class> >(params, gg, useLeapfrog,
