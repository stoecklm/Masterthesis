...
class HeatEqnFdmTimeLinSpaceLinNeumann : public HeatEqnFDM<CT,DIM, HeatEqnFdmTimeLinSpaceLinNeumann<CT,DIM> > {
  ...
  public:
     ...
     */
    HeatEqnFdmTimeLinSpaceLinNeumann(ScaFES::Parameters const& params,
        ...
        : HeatEqnFDM<CT, DIM, HeatEqnFdmTimeLinSpaceLinNeumann<CT,DIM> >(params, gg, useLeapfrog,
