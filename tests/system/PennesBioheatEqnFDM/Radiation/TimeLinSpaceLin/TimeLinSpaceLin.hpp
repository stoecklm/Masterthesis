...
#ifndef PENNESHEATEQNFDM_RADIATION_TIMELINSPACELIN_HPP_
#define PENNESHEATEQNFDM_RADIATION_TIMELINSPACELIN_HPP_

#include "ScaFES.hpp"
#include "Radiation.hpp"

template<typename CT, std::size_t DIM>
class TimeLinSpaceLin : public Radiation<CT,DIM, TimeLinSpaceLin<CT,DIM> > {
  ...
  public:
    ...
    TimeLinSpaceLin(ScaFES::Parameters const& params,
        ...
        : Radiation<CT, DIM, TimeLinSpaceLin<CT,DIM> >(params, gg, useLeapfrog,
    ...
    void evalBorder(std::vector< ScaFES::DataField<CT, DIM> >& vNew,
        ...
        if (useRadiation == true) {
            ...
            vNew[1](idxNode) *= (1.0 + t);
            vNew[1](idxNode) = vNew[1](idxNode) * vNew[1](idxNode) * vNew[1](idxNode) * vNew[1](idxNode);
            vNew[1](idxNode) *= this->SIGMA * this->EPSILON;
