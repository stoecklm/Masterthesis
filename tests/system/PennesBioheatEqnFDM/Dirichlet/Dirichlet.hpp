...
#ifndef PENNESBIOHEATEQNFDM_DIRICHLET_HPP_
#define PENNESBIOHEATEQNFDM_DIRICHLET_HPP_

#include "ScaFES.hpp"
#include "PennesBioheatEqnFDM.hpp"

template<typename CT, std::size_t DIM, typename Class>
class Dirichlet : public PennesBioheatEqnFDM<CT,DIM, Dirichlet<CT,DIM, Class> > {
  ...
  public:
    ...
    Dirichlet(ScaFES::Parameters const& params,
        ...
        : PennesBioheatEqnFDM<CT, DIM, Dirichlet<CT,DIM,Class> >(params, gg, useLeapfrog,
