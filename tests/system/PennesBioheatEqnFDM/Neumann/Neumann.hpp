...
#ifndef PENNESBIOHEATEQNFDM_NEUMANN_HPP_
#define PENNESBIOHEATEQNFDM_NEUMANN_HPP_

#include "ScaFES.hpp"
#include "PennesBioheatEqnFDM.hpp"

template<typename CT, std::size_t DIM, typename Class>
class Neumann : public PennesBioheatEqnFDM<CT,DIM, Neumann<CT,DIM, Class> > {
  ...
  public:
     ...
     */
    Neumann(ScaFES::Parameters const& params,
        ...
        : PennesBioheatEqnFDM<CT, DIM, Neumann<CT,DIM,Class> >(params, gg, useLeapfrog,
