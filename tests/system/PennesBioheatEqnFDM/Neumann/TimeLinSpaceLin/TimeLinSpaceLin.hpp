...
#ifndef PENNESBIOHEATEQNFDM_NEUMANN_TIMELINSPACELIN_HPP_
#define PENNESBIOHEATEQNFDM_NEUMANN_TIMELINSPACELIN_HPP_

#include "ScaFES.hpp"
#include "Neumann.hpp"

template<typename CT, std::size_t DIM>
class TimeLinSpaceLin : public Neumann<CT,DIM, TimeLinSpaceLin<CT,DIM> > {
  ...
  public:
    ...
    TimeLinSpaceLin(ScaFES::Parameters const& params,
        ...
        : Neumann<CT, DIM, TimeLinSpaceLin<CT,DIM> >(params, gg, useLeapfrog,
